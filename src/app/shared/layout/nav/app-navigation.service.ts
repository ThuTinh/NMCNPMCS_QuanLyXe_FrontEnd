    ...
    getMenu(): AppMenu {
        return new AppMenu('MainMenu', 'MainMenu', [
            ...
            new AppMenuItem('Administration', '', 'flaticon-interface-8', '', [
                ...
                new AppMenuItem('PhiDuongBo', 'Pages.Administration.PhiDuongBo', 'flaticon-menu-1', '/app/gwebsite/phiDuongBo'),
                new AppMenuItem('ThongTinSuaChua', 'Pages.Administration.ThongTinSuaChua', 'flaticon-menu-1', '/app/gwebsite/thongTinSuaChua')
            ]),
