...
@Injectable()
export class QuanlyxeServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getQuanlyxesByFilter(name: string | null | undefined, sorting: string | null | undefined, maxResultCount: number | null | undefined, skipCount: number | null | undefined): Observable<PagedResultDtoOfQuanlyxeDto> {
        let url_ = this.baseUrl + "/api/Quanlyxe/getQuanlyxesByFilter?";
        if (name !== undefined)
            url_ += "Name=" + encodeURIComponent("" + name) + "&"; 
        if (sorting !== undefined)
            url_ += "Sorting=" + encodeURIComponent("" + sorting) + "&"; 
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processgetQuanlyxesByFilter(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processgetQuanlyxesByFilter(<any>response_);
                } catch (e) {
                    return <Observable<PagedResultDtoOfQuanlyxeDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<PagedResultDtoOfQuanlyxeDto>><any>_observableThrow(response_);
        }));
    }

    protected processgetQuanlyxesByFilter(response: HttpResponseBase): Observable<PagedResultDtoOfQuanlyxeDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? PagedResultDtoOfQuanlyxeDto.fromJS(resultData200) : new PagedResultDtoOfQuanlyxeDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<PagedResultDtoOfQuanlyxeDto>(<any>null);
    }
     ...
     * @return Success
     */
    getQuanlyxeForEdit(id: number | null | undefined): Observable<QuanlyxeInput> {
        let url_ = this.baseUrl + "/api/Quanlyxe/GetQuanlyxeForEdit?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetQuanlyxeForEdit(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetQuanlyxeForEdit(<any>response_);
                } catch (e) {
                    return <Observable<QuanlyxeInput>><any>_observableThrow(e);
                }
            } else
                return <Observable<QuanlyxeInput>><any>_observableThrow(response_);
        }));
    }

    protected processGetQuanlyxeForEdit(response: HttpResponseBase): Observable<QuanlyxeInput> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? QuanlyxeInput.fromJS(resultData200) : new QuanlyxeInput();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<QuanlyxeInput>(<any>null);
    }
     ...
     * @return Success
     */
    createOrEditQuanlyxe(input: QuanlyxeInput | null | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/Quanlyxe/CreateOrEditQuanlyxe";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateOrEditQuanlyxe(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateOrEditQuanlyxe(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateOrEditQuanlyxe(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    deleteQuanlyxe(id: number): Observable<void> {
        let url_ = this.baseUrl + "/api/Quanlyxe/DeleteQuanlyxe/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id)); 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteQuanlyxe(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteQuanlyxe(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeleteQuanlyxe(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getQuanlyxeForView(id: number | null | undefined): Observable<QuanlyxeForViewDto> {
        let url_ = this.baseUrl + "/api/Quanlyxe/GetQuanlyxeForView?";
        if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&"; 
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetQuanlyxeForView(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetQuanlyxeForView(<any>response_);
                } catch (e) {
                    return <Observable<QuanlyxeForViewDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<QuanlyxeForViewDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetQuanlyxeForView(response: HttpResponseBase): Observable<QuanlyxeForViewDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? QuanlyxeForViewDto.fromJS(resultData200) : new QuanlyxeForViewDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<QuanlyxeForViewDto>(<any>null);
    }
}
...
export class PagedResultDtoOfQuanlyxeDto implements IPagedResultDtoOfQuanlyxeDto {
    totalCount!: number | undefined;
    items!: QuanlyxeDto[] | undefined;

    constructor(data?: IPagedResultDtoOfQuanlyxeDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(data?: any) {
        if (data) {
            ...
            if (data["items"] && data["items"].constructor === Array) {
                this.items = [];
                for (let item of data["items"])
                    this.items.push(QuanlyxeDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PagedResultDtoOfQuanlyxeDto {
        data = typeof data === 'object' ? data : {};
        let result = new PagedResultDtoOfQuanlyxeDto();
        result.init(data);
        return result;
    }
...
export interface IPagedResultDtoOfQuanlyxeDto {
    totalCount: number | undefined;
    items: QuanlyxeDto[] | undefined;
}

export class QuanlyxeDto implements IQuanlyxeDto {
    name!: string | undefined;
    address!: string | undefined;
    info!: string | undefined;
    id!: number | undefined;

    constructor(data?: IQuanlyxeDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): QuanlyxeDto {
        data = typeof data === 'object' ? data : {};
        let result = new QuanlyxeDto();
        result.init(data);
        return result;
    }
...
export class QuanlyxeInput implements IQuanlyxeInput {
    name!: string | undefined;
    address!: string | undefined;
    info!: string | undefined;
    id!: number | undefined;

    constructor(data?: IQuanlyxeInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): QuanlyxeInput {
        data = typeof data === 'object' ? data : {};
        let result = new QuanlyxeInput();
        result.init(data);
        return result;
    }
...
export interface IQuanlyxeInput {
    name: string | undefined;
    address: string | undefined;
    info: string | undefined;
    id: number | undefined;
...
export class QuanlyxeForViewDto implements IQuanlyxeForViewDto {
    name!: string | undefined;
    address!: string | undefined;
    info!: string | undefined;

    constructor(data?: IQuanlyxeForViewDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): QuanlyxeForViewDto {
        data = typeof data === 'object' ? data : {};
        let result = new QuanlyxeForViewDto();
        result.init(data);
        return result;
    }
...
export interface IQuanlyxeForViewDto {
    name: string | undefined;
    address: string | undefined;
    info: string | undefined;
}
